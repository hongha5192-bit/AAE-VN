...
Usage:
    python training/generate_dataset.py [--augment] [--backtest-url http://localhost:8002]
"""
...
def build_conversation(seed: dict, system_prompt: str) -> list[dict]:
    ...
    hypothesis = seed.get("hypothesis", "N/A")
    user_msg = (
...
def main():
    ...
    parser.add_argument("--backtest-url", default="http://localhost:8002", help="Backtest API URL")
