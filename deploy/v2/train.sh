...
ROLLOUT_MAX_BATCHED_TOKENS="${ROLLOUT_MAX_BATCHED_TOKENS:-2048}"
ROLLOUT_MAX_SEQS="${ROLLOUT_MAX_SEQS:-1}"
PPO_MAX_TOKEN_LEN_PER_GPU="${PPO_MAX_TOKEN_LEN_PER_GPU:-1024}"
FORWARD_MAX_TOKEN_LEN_PER_GPU="${FORWARD_MAX_TOKEN_LEN_PER_GPU:-1024}"
LOG_PROB_MAX_TOKEN_LEN_PER_GPU="${LOG_PROB_MAX_TOKEN_LEN_PER_GPU:-1024}"
